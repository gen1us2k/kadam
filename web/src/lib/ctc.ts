// Pure CTC helpers — no browser/ORT dependencies, so they can be unit-tested in Node against the
// Python reference (scripts export the same math). asr.ts wires these to onnxruntime-web output.
